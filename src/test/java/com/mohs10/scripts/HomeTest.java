...
public class HomeTest extends StartBrowser {
	...
	public void LoginTestCase() throws Exception {
	  ...
	  @Test public void LoginTestCase2() throws Exception {
	 ...
	 // excelsheet, i, 1);}
	  ...
	  // hm2.logout(); } driver.close();
	  
	  }
	  
		/*
		  @Test public void LoginTestCase3() throws Exception {
		  ...
		  driver = StartBrowser.launchapp("msedge", "https://mohs10.io/");
		  System.out.println(driver);
		  
		  //hm2.CommonsFun("Dipanwita","dipanwita.chakraborty@mohs10.io", "abc","abd");
		  
		  SSreuseclass.SSReusablemethod(driver,"login"); Thread.sleep(5000);
